...
def base_args(parser):
    ...
    parser.add_argument("--seed", type=int, default=7122, help="Set random seed.")
    parser.add_argument("--njobs", type=int, default=2, help="Number of workers.")
    parser.add_argument(
        "--override", type=str, default="", help="Overrides arguments or configs. "
    )
